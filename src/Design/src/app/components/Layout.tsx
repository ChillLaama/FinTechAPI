...
export function Layout() {
  ...
  const navItems = [
    ...
    { path: "/transactions", label: "Транзакции", icon: CreditCard },
    { path: "/create-payment", label: "Создать платёж", icon: PlusCircle },
  ];
            ...
            <div className="relative pl-4 border-l border-border">
              ...
              >
                <div className="w-9 h-9 rounded-full bg-primary flex items-center justify-center">
                  <span className="text-sm text-primary-foreground">АП</span>
                </div>
              </button>
                ...
                <>
                  ...
                  <div className="absolute right-0 top-full mt-2 w-56 bg-card border border-border rounded-lg shadow-lg z-20 overflow-hidden">
                    <div className="p-3 border-b border-border">
                      <p className="text-sm text-foreground">Александр Петров</p>
